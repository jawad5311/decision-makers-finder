...
This Manifest V3 extension adds a floating **Find the Decision Makers** button to ordinary websites. It keeps the company website open and opens a new background Google-search tab for each query, with a 2-second gap between launches. Launches continue independently of earlier tabs loading or being read; there is no three-tab limit.
